    ...
    <div className="relative flex items-center justify-center min-h-screen w-screen bg-gray-900 overflow-hidden">
      ...
      {/* Neon ring background */}
       <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="neon-ring absolute w-[600px] sm:w-[400px] md:w-[700px] lg:w-[700px] aspect-square rounded-full border-8 border-transparent" 
             style={{
      ...
      {/* Form container */}
      <div className="relative bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-2xl p-9 absolute w-[350px] sm:w-[400px] md:w-[450px] lg:w-[500px]  z-10 border border-gray-700">
