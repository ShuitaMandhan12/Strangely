...
const socket = io('http://localhost:5000', {  // Use your actual Replit URL
  path: '/socket.io/',
              ...
              >
                ...
                <div className={`max-w-xs md:max-w-md relative ${
                  ...
                  {showEmojiPalette === msg.id && (
                    <div 
                      ref={emojiPaletteRef}
                      className={`absolute ${msg.username === username ? 'left-0 ' : 'right-2 sm:right-0 sm:-mr-10'} top-full mb-2 z-50 fixed sm:absolute z-50`}
                      style={{ 
